function [OrderMat,IOut,JOut,MaskOrderOut] = ...
                             SpiralRect_LocalShuffle(Length1, Length2, ...
                                                       TRtimesCutoffFreq, ...
                                                       bSampleMask, ...
                                                       ExtraParamsStruct, ...
                                                       RandomSeed, ...
...
%                                                      RandomSeed, ...
%                                                      bPlot)
% Generates a rectangulare spiral trajectory within a Cartesian matrix of
...
%% Initial setup - set defaults for missing inputs
  ...
  bPlot0 = false ;
  [OrderMat0] = ...
              Ordering.BaseTraj.SpiralRect(Length1, Length2, ...
