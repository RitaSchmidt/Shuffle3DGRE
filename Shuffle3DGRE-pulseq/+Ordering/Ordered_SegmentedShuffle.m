function [OrderMat,IOut,JOut,MaskOrderOut] = ...
                              Ordered_SegmentedShuffle(Length1, Length2, ...
                                                       TRtimesCutoffFreq, ...
                                                       bSampleMask, ...
                                                       ExtraParamsStruct, ...
                                                       RandomSeed, ...
...
% trajectory and returns a segmented shuffled version of the trajectory.
%
% Inputs:
% -------
...
%% Initial setup - set defaults for missing inputs
  ...
  [OrderMat,IOut,JOut,MaskOrderOut] = ...
        Ordering.Utils.SegmentedShuffleInputTrajectory(OrderMat0, ...
                                                       TRtimesCutoffFreq, ...
                                                       bSampleMask, ...
                                                       RandomSeed, ...
                                                       bPlot) ;
