function [OrderMat,IOut,JOut,MaskOrderOut] = ...
                                 SpiralRS_LocalShuffle(Length1, Length2, ...
                                                       TRtimesCutoffFreq, ...
                                                       bSampleMask, ...
                                                       ExtraParamsStruct, ...
                                                       RandomSeed, ...
...
%                                                      RandomSeed, ...
%                                                      bPlot)
% Generates a spiral-like trajectory within a Cartesian matrix of
...
%% Initial setup - set defaults for missing inputs
  ...
  bPlot0 = false ;
  [OrderMat0] = Ordering.BaseTraj.SpiralRS(Length1, Length2, ...
